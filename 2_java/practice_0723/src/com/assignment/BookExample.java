...
public class BookExample {
	public static void main(String[] args) {
		...
		bm.addBook(new Book("가 언어의 온도","이기주",2018, 551));
		bm.addBook(new Book("나 자존감 수업","윤홍균",2006, 394));
		bm.addBook(new Book("다 나미야 잡화점의 기적","히가시노 게이고",2008, 468));
		bm.addBook(new Book("라 살인자의 기억법","김영하",2023, 264));
